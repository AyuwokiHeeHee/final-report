...
class Mainchara:
    def __init__(self):
        ...
        window.addshape(r'/Users/mac/Desktop/final-report/Untitled/mainchara.gif')
        self.Mainchara.shape(r'/Users/mac/Desktop/final-report/Untitled/mainchara.gif')
...
class Laser:
    def __init__(self):
        ...
        window.addshape(r'/Users/mac/Desktop/final-report/Untitled/laser  .gif')
        self.Laser.speed(0)
        self.Laser.shape(r'/Users/mac/Desktop/final-report/Untitled/laser  .gif')
        self.Laser.penup()
...
class Alien:
    def __init__(self):
        ...
        for _ in range(5):
            alien = turtle.Turtle()
            alien.speed(0)
            window.addshape(r'/Users/mac/Desktop/final-report/Untitled/e1 .gif')
...
window.bgpic(r'/Users/mac/Desktop/final-report/Untitled/bg (2).gif')
window.title('robot')
...
while True:
    ...
    for alien in alien_group.aliens:
        ...
        if mainchara.Mainchara.distance(alien) < 20:
            alien_group.hide()
            mainchara.hide()
            turtle.write(f'YOU LOSE' align='center', font=('Courier', 50, 'normal')) 
